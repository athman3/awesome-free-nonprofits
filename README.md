...
- [1Password](https://1password.com/for-non-profits/) - Password manager and secrets management platform.
- [AWS](https://aws.amazon.com/government-education/nonprofits/) - Cloud computing platform offering over 200 services for compute, storage, and databases.
- [Microsoft](https://www.microsoft.com/en-us/nonprofits/) - Comprehensive suite of productivity, collaboration, and cloud services.
- [Norton](https://www.techsoup.org/norton) - Cybersecurity software providing antivirus protection, firewall, and VPN.
- [Webflow](https://help.webflow.com/hc/en-us/articles/33961230168467-Nonprofit-Organization-NPO-discount) - Professional website builder and CMS for creating custom websites without coding.
- [Wix](https://support.wix.com/en/article/premium-plan-discount-for-charities-or-non-profit-organizations) - Drag-and-drop website builder with designer templates.
...
- [HubSpot](https://www.hubspot.com/nonprofits) - CRM platform combining marketing, sales, and service software.
- [LinkedIn](https://nonprofit.linkedin.com/) - Professional network for marketing, fundraising, and supporter engagement.
- [Mailchimp](https://mailchimp.com/help/about-nonprofit-discount/) - Email marketing platform for newsletters and campaigns.
- [Notion](https://www.notion.so/nonprofits) - All-in-one workspace for donor management, fundraising tracking, and documentation.
- [Salesforce](https://www.salesforce.org/nonprofit/) - Cloud-based CRM platform for donor management and fundraising.
